...
So I tried querying a large Chinese Internet search engine for each of my words, to get some measure of which words were common enough to warrant disregarding my reading notes and just saying "here's a translation that's 'out there' and worth recognising". I had to be careful to ensure the search results really showed the word in _common_ use (not just illegal copies of the source I read), and I also had to beware of having documented a rare different use-case of an otherwise common word. (Before these edits, the queries themselves were made automatically from 2017 to 2019, as the search company seemingly hadn't yet prohibited being used by automatic programs. I then discovered their Terms of Use were split across several separate Web pages, of which I had read only one, and they had in fact prohibited automatic use since 2013. Now I know this, I'm limited to querying it manually for any more words I consider adding to CedPane, but the words I previously added are not legally "tainted" because they're only a miniscule sample of their full list of indexed terms.)

After subsetting and editing my database, I can now present 62% of the ‘specialist’ words I collected between 2009 and 2019 as confirmed “public domain” words you can _do what you want_ with (i.e. please _do_ add them to products to help learners—and email me if you’d like me to mention here that you’ve added it to your product). The other 38% (and my reading notes) have not been added to CedPane, but I hope it’s already useful.
